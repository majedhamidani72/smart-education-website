...
export default function BookCard({ book, href }: { book: Book; href: string }) {
  return (
    ...
    >
      <div className="flex h-24 w-16 items-center justify-center rounded-lg bg-gradient-to-b from-gray-50 to-gray-100 text-2xl transition group-hover:scale-105">
        📗
      </div>
